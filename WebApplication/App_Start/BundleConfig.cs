...
namespace WebApplication
{
    public class BundleConfig
    {
        public static void RegisterBundles(BundleCollection bundles)
        {
            ...
            RegisterVisitor(bundles);
            RegisterVisitorLog(bundles);
        }
        ...
        private static void RegisterVisitor(BundleCollection bundles)
        {
            bundles.Add(new ScriptBundle("~/Scripts/Visitor/menu").Include(
                "~/Scripts/Visitor/Index-menu.js"));
            bundles.Add(new ScriptBundle("~/Scripts/Visitor/index").Include(
                "~/Scripts/Visitor/Index.js"));
        }
        private static void RegisterVisitorLog(BundleCollection bundles)
        {
            bundles.Add(new ScriptBundle("~/Scripts/Visitor/logmenu").Include(
                "~/Scripts/Visitor/Log-menu.js"));
            bundles.Add(new ScriptBundle("~/Scripts/Visitor/log").Include(
                "~/Scripts/Visitor/Log.js"));
        }
    }
}
